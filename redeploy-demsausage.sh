...
docker-compose -f docker-compose-prod-demsausage.yml pull
docker-compose -f docker-compose-prod-demsausage.yml stop
docker-compose -f docker-compose-prod-demsausage.yml up --remove-orphans -d
