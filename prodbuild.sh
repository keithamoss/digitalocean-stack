...
SCREMSONG_VERSION_FILE="../scremsong/VERSION"
if [ ! -f "$SCREMSONG_VERSION_FILE" ]; then
    echo "Scremsong version file not found!"
    exit 1
fi

DEMSAUSAGE_VERSION=`cat $DEMSAUSAGE_VERSION_FILE`
SCREMSONG_VERSION=`cat $SCREMSONG_VERSION_FILE`
PUSH="$1"
...
SCREMSONG_VERSION="$SCREMSONG_VERSION"
SCREMSONG_DJANGO_VERSION="$SCREMSONG_VERSION"
