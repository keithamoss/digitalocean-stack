...
docker compose -f demsausage-production.yml pull
docker compose -f demsausage-production.yml stop
docker compose -f demsausage-production.yml up --remove-orphans -d
